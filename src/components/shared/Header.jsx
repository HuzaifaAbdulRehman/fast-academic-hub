...
export default function Header() {
  ...
  return (
    <>
      <header className="bg-dark-surface/95 backdrop-blur-xl border-b border-dark-border/50 sticky top-0 z-30 shadow-lg w-full left-0 right-0">
        <div className="w-full px-4 md:px-6 py-3 md:py-2.5">
